---
name: markdown-blog
description: 新建一个专业的markdown说明和知识介绍文件。当用户要求用markdown文件描述以下内容：一种技术，一种代码库，一种编程语言，一段历史，一种事务，一个人物等等，请使用此技能。该技能用于生成专业的markdown说明和知识介绍文件。
license: Complete terms in LICENSE.txt
---

# 需要生成markdown文件时，按照以下需求生成：
- 风格/语气：技术严谨
- 在开头添加 YAML Front Matter (title, date, tags, categories)，date格式为XXXX-XX-XX 06:24:00
- 文件名称格式：日期_标题（需要去除特殊字符），比如：2026-01-22_Git 核心对象：Commit, Tree, Blob 详解。 生成的文件放项目目录：source\_posts\下的对应的年份目录下
- 可以包含代码示例，代码示例用GO语言，Python，有必要的时候也可以用其他语言
- 提供关键概念的定义
- 如果必要可以使用mermaid画图
- 字数控制在4000字以内
